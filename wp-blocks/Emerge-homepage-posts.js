    ...
    return (
        <section
            className="bg-gradient-to-t pt-12 pb-24 from-[#F4F0FF] via-white to-transparent
              w-full px-[20px] lg:px-[128px] overflow-hidden"
        >
            <div className="flex flex-col items-center w-full">
                <div className="font-Inter text-left font-Inter text-[#100650] font-medium uppercase min-h-[2.25rem] bg-opacity-5 bg-[#4A00FF0F] px-2.5 rounded-[.375rem] py-2 w-fit">
                    Our blog
                </div>
                <div className="flex flex-row items-center mt-4">
                    <h1 className="font-Satoshi font-bold text-black text-[2.625rem] text-center">
                        Latest News & Updates
                    </h1>
                </div>
                        ...
                        return (
                            <Link href={post?.slug} className="cursor-pointer">
                                <div className="flex flex-col cursor-pointer">
                                    <div className="rounded-[1rem] mb-6 relative
                                     lg:w-[24rem] w-full h-[15rem]">
                                        <Image src={post.featuredImage ? post.featuredImage.node.sourceUrl : ""} className='aspect-w-16 aspect-h-10 object-cover' alt={data.title} layout="fill"  />
                                    </div>
                                    ...
                                    <div className="flex flex-row items-center justify-between mt-2">
                                        ...
                                        <div className="w-1/5">
                                            <svg className="w-[1.5rem] h-[1.5rem]" width="24" height="28" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="flex flex-row mt-6">
                                        <img src={post?.author?.node?.avatar?.url} className="w-[2.5rem] h-[2.5rem] rounded-full aspect-1" />
